...
var menuname = document.querySelector("#menuidea span");
var menupic = document.querySelector("#menuidea img");
...
var menuidea = menus[Math.floor(Math.random() * menus.length)];
...
//***** Functions
var paintGreetings = function paintGreetings(username) {
  var menuname = document.querySelector("#menuidea span");
  greeting.innerHTML = "\uC548\uB155\uD558\uC138\uC694, <b>".concat(username, "</b>\uB2D8! ");
  menuname.innerHTML = " \uC624\uB298\uC740<br><i><b>".concat(menuidea.name, "</b></i><br>\uC5B4\uB5A0\uC138\uC694?");
...
var onSettingsClick = function onSettingsClick(e) {
  var confirmReset = confirm("저장된 모든 설정값을 삭제합니다.");
  if (confirmReset) {
    localStorage.clear();
...
var onSettingsEnter = function onSettingsEnter(e) {
  settings.innerHTML = "&#9881; Click to reset.";
};
var onSettingsLeave = function onSettingsLeave(e) {
  settings.innerHTML = "&#9881;";
};

//***** Condition check
var hasUsername = localStorage.getItem(USERNAME_KEY);
if (hasUsername) {
  // loginForm.classList.add(HIDDEN_CLASSNAME);
